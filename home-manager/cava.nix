...
gradient = 1
gradient_count = 6
gradient_color_1 = '#${color.pine}'
gradient_color_2 = '#${color.foam}'
gradient_color_3 = '#${color.iris}'
gradient_color_4 = '#${color.rose}'
gradient_color_5 = '#${color.gold}'
gradient_color_6 = '#${color.love}'
